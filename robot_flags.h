...
const unsigned int R_F_ISTASKABS=0x100;
...
#define F_ISTASKABS() (flags&R_F_ISTASKABS)
...
#define F_SETTASKABS() (flags=(flags|(R_F_ISTASK|R_F_ISTASKABS))&~(R_F_ISTMO|R_F_ISTFIN))
#define F_CLEARTASK() (flags&=~(R_F_ISTASK|R_F_ISTASKMOV|R_F_ISTASKROT|R_F_ISTASKABS))
...
enum EnumCmd { EnumCmdDrive=1, EnumCmdTest=2, EnumCmdStop=3, EnumCmdLog=4, EnumCmdContinueDrive=5, EnumCmdRst=6, 
    EnumCmdTaskMove=7, EnumCmdTaskRotate=8, EnumCmdWallLog=9, EnumCmdSetParam=10, EnumCmdTaskAbs=11};  
